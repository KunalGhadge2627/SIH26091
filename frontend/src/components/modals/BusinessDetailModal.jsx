      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 md:p-8 space-y-6 border border-turf-border relative">
        <div className="flex items-center justify-between border-b border-turf-border pb-4">
          <div>
            ...
            <h2 className="text-xl font-bold text-turf-text">{t(model?.display_name || category)}</h2>
          </div>
          <button 
            onClick={onClose}
        ...
        {model ? (
          <div className="space-y-6 text-xs text-turf-text">
            <p className="text-sm text-turf-text-muted leading-relaxed">{t(model.description)}</p>

            <div className="p-4 rounded-2xl bg-turf-surface border border-turf-border flex items-center justify-between">
              <span className="font-semibold text-turf-text">{t('Capital requirement:')}</span>
            ...
            <div className="space-y-2">
              <span className="font-semibold text-turf-text block text-xs">{t('Demand drivers')}</span>
            ...
            <div className="space-y-2">
              <span className="font-semibold text-turf-text block text-xs">{t('Supply signals')}</span>
              <ul className="space-y-1.5 pl-2">
            ...
            <div className="space-y-2">
              <span className="font-semibold text-turf-text block text-xs">{t('Risk factors')}</span>
              <ul className="space-y-1.5 pl-2">
          ...
          <div className="py-8 text-center text-xs text-turf-text-muted">{t('Loading business category details...')}</div>
        )}
