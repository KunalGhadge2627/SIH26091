    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="bg-white border-b border-turf-border sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-semibold text-turf-text-muted">
            <a href="#how-it-works" className="hover:text-turf-primary transition-colors">{t('How it works')}</a>
            <a href="#what-we-assess" className="hover:text-turf-primary transition-colors">{t('What we assess')}</a>
            <a href="#why-it-matters" className="hover:text-turf-primary transition-colors">{t('Why it matters')}</a>
          </div>
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              className="px-3 py-2 text-xs font-semibold text-turf-text bg-white border border-turf-border rounded-xl focus:outline-none focus:border-turf-primary"
            >
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-turf-text leading-tight tracking-tight">
              {t('Make better business decisions before taking a loan.')}
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-turf-surface border border-turf-border rounded-2xl p-6 space-y-3">
              ...
              <h3 className="text-base font-bold text-turf-text">{t('Business ↔ Location')}</h3>
            ...
            <div className="bg-turf-surface border border-turf-border rounded-2xl p-6 space-y-3">
              ...
              <h3 className="text-base font-bold text-turf-text">{t('Person ↔ Business')}</h3>
              <p className="text-xs text-turf-text-muted leading-relaxed">
            ...
            <div className="bg-turf-surface border border-turf-border rounded-2xl p-6 space-y-3">
              ...
              <h3 className="text-base font-bold text-turf-text">{t('Person ↔ Finance')}</h3>
              <p className="text-xs text-turf-text-muted leading-relaxed">
            ...
            {featureGrid.map((feat, idx) => {
              ...
              return (
                <div key={idx} className="p-5 rounded-2xl bg-white border border-turf-border hover:bg-turf-surface/40 transition-all space-y-2">
                  ...
                  <h3 className="text-sm font-bold text-turf-text">{t(feat.title)}</h3>
                  <p className="text-xs text-turf-text-muted leading-relaxed">{t(feat.desc)}</p>
                </div>
              );
            })}
          </div>
      ...
      <section id="how-it-works" className="py-16 bg-white border-b border-turf-border">
        <div className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-turf-text">{t('How it works')}</h2>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {steps.map((st, idx) => (
              <div key={idx} className="bg-white border border-turf-border rounded-2xl p-6 space-y-3">
                ...
                <h3 className="text-sm font-bold text-turf-text">{t(st.title)}</h3>
                <p className="text-xs text-turf-text-muted leading-relaxed">{t(st.desc)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="why-it-matters" className="py-16 bg-turf-primary text-white">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
          <span className="eyebrow !text-white/80">{t('Our mission')}</span>
