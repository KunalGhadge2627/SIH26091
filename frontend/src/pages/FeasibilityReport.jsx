    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-6 md:p-10 max-w-6xl mx-auto w-full space-y-8 print:p-0">
          ...
          {/* Section 1: Score Hero (Data Surface Card) */}
          <div className="bg-turf-surface border border-turf-border rounded-2xl p-8 text-center space-y-6">
          ...
          {/* Section 2: Three Sub-Score Rings (Data Cards) */}
          ...
          <div className="grid md:grid-cols-4 gap-4 print:hidden">
            <Link
              ...
              className="p-5 rounded-2xl bg-white border border-turf-border hover:border-turf-primary transition-all space-y-2 group"
            >
              <div className="font-bold text-xs text-turf-text group-hover:text-turf-primary flex items-center justify-between">
