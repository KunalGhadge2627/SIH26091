        ...
        <main className="p-6 md:p-10 max-w-5xl mx-auto w-full space-y-8">
          ...
          <div className="flex items-center justify-between border-b border-turf-border pb-4">
            <div>
              ...
              <h1 className="text-2xl font-bold text-turf-text">
                {t('User Profile')}
              </h1>

              <p className="text-xs text-turf-text-muted mt-0.5">
                {t(
                  'Manage your personal details, language preferences, and accessibility settings.'
                )}
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-4 bg-turf-surface border border-turf-border rounded-2xl p-6 text-center space-y-4">
              ...
              <div>
                <h3 className="text-base font-bold text-turf-text">
                  {profileData.full_name || t('User')}
                </h3>
            ...
            <div className="md:col-span-8 bg-white border border-turf-border rounded-2xl p-6 md:p-8 space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-turf-border pb-3">
                ...
                <span className="text-xs text-turf-text-muted">
                  {t('ID')}: {user?.id}
                </span>
              </div>
              ...
              {isEditing ? (
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block font-semibold text-turf-text mb-1">
                        {t('Full Name')}
                      </label>
                  ...
                  <div className="pt-2 flex justify-end">
                    ...
                    <button
                      type="submit"
                      disabled={saving}
                      className="px-6 py-2.5 bg-turf-primary hover:bg-emerald-700 text-white font-semibold rounded-xl flex items-center gap-1.5 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                ...
                <div className="grid sm:grid-cols-2 gap-6 text-xs">
                  ...
                  <div>
                    <span className="text-turf-text-muted font-medium block">
                      {t('Full Name')}
                    </span>
                  ...
                  <div>
                    ...
                    <span className="font-bold text-turf-text text-sm stat-number">
                      {profileData.mobile}
                    </span>
                  </div>
                  ...
                  <div>
                    ...
                    <span className="font-bold text-turf-text text-sm">
                      {languagesList.find(
                        (l) =>
                          l.code === profileData.preferred_language
                      )?.native || 'English'}
                    </span>
                  </div>
                  ...
                  <div>
                    <span className="text-turf-text-muted font-medium block">
                      {t('Prior Business Experience')}
                    </span>

                    <span className="font-bold text-turf-text text-sm">
                      {t(profileData.business_experience)}
                    </span>
                  </div>
            ...
            <div className="space-y-4 divide-y divide-turf-border text-xs">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-turf-text">
                      {t('App Language')}
                    </div>

                    <div className="text-turf-text-muted">
                      {t(
                        'English, Hindi and 7 more Indic languages supported'
                      )}
                    </div>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-turf-text-muted">
                      {t(
                        'High-contrast visuals and reduced animation settings'
                      )}
                    </div>
                  </div>
          ...
          <div className="bg-turf-surface border border-turf-border rounded-2xl p-6 flex items-center justify-between">
            ...
            <div>
              ...
              <p className="text-xs text-turf-text-muted mt-0.5">
                {t(
                  'Clears active session token from browser local storage.'
                )}
              </p>
            </div>
